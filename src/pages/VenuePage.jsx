...
const VenuePage = () => {
  ...
  const isBooked = (date) => {
    ...
    return bookedDates.some(
      (bookedDate) => formattedDate.toDateString() === bookedDate.toDateString()
    );
  };
  ...
  const tileClassName = ({ date, view }) => {
    ...
    if (date.toDateString() === startDate?.toDateString())
      return "selected-start"; // Class name for start date
              ...
              <>
                {profile?.email !== venue?.owner?.email ? (
                  <>
                    ...
                    <SubmitButton onClick={handleBooking}>
                      Confirm Booking
                    </SubmitButton>
